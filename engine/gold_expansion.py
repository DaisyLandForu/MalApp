...
def _latest_suite(data_dir: Path) -> dict[str, Any]:
    from engine.five_layer_evaluation import latest_suite
...
def _suite_records(
    ...
    from engine.five_layer_evaluation import official_gold_row
...
def freeze_gold_expansion(
    *,
    ...
    from engine.five_layer_evaluation import generate_five_layer_suite
