...
def evaluation_command(args: list[str]) -> list[str]:
    ...
    return [sys.executable, str(ROOT / "tools" / "evaluation_cli.py"), *args]
...
def main() -> None:
    ...
    raise SystemExit("usage: python -m engine.five_layer_workflows --worker <job.json>")
